...
This file is the quick-reference operating contract for owo-colors-kotlin. The longer
...
owo-colors-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`owo-colors`](https://crates.io/crates/owo-colors). Upstream Rust is the behavioral oracle while the
