...
kotlin {
    ...
    val xcf = XCFramework("OwoColors")

    macosArm64 {
        binaries.framework { baseName = "OwoColors"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "OwoColors"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "OwoColors"
        flattenPackage = "io.github.kotlinmania.owocolors"
    }

    android {
        namespace = "io.github.kotlinmania.owocolors"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "owo-colors-kotlin", version.toString())

    pom {
        name.set("owo-colors-kotlin")
        description.set("Kotlin Multiplatform port of owo-colors/owo-colors - Zero-allocation terminal colors that'll make people go owo")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/owo-colors-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/owo-colors-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/owo-colors-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/owo-colors-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleOwoColorsXCFramework",
    "assembleOwoColorsDebugXCFramework",
    "assembleOwoColorsReleaseXCFramework",
    "assembleDebugIosFatFrameworkForOwoColorsXCFramework",
    "assembleReleaseIosFatFrameworkForOwoColorsXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForOwoColorsXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForOwoColorsXCFramework",
    "assembleDebugMacosFatFrameworkForOwoColorsXCFramework",
    "assembleReleaseMacosFatFrameworkForOwoColorsXCFramework",
    "assembleDebugTvosFatFrameworkForOwoColorsXCFramework",
    "assembleReleaseTvosFatFrameworkForOwoColorsXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForOwoColorsXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForOwoColorsXCFramework",
    "assembleDebugWatchosFatFrameworkForOwoColorsXCFramework",
    "assembleReleaseWatchosFatFrameworkForOwoColorsXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForOwoColorsXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForOwoColorsXCFramework",
